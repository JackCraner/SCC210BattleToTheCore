...
public class RendererGameSystem  extends GameSystem
{
    ...
    private RendererGameSystem()
    {
        ...
        try
        {
            font.loadFromFile(Paths.get("/home/cowleyb/h-drive/SCC210BattleToTheCore-ECSTesting/RPGTeamGame/Assets" + File.separator + "Fonts" + File.separator+ "LEMONMILK-Regular.otf"));
