...
//Collision matrix unit GO LOOK
    //go fix enemy kill eachother
    ...
    public void startGame()
    {
        ...
        //ENTITYMANAGER.addGameObject(Blueprint.enemy(new Vector2f(PLAYER.getComponent(Position.class).getPosition().x + 1300,PLAYER.getComponent(Position.class).getPosition().y + 100)));
        ENTITYMANAGER.addGameObject(Blueprint.enemy(new Vector2f(2600,700)));
        ENTITYMANAGER.addGameObject(Blueprint.enemy(new Vector2f(2700,900)));
        ENTITYMANAGER.addGameObject(Blueprint.enemy( new Vector2f(2800,1000)));
        ...
        try
        {
            sb.loadFromFile(Paths.get("/home/cowleyb/h-drive/SCC210BattleToTheCore-ECSTesting/RPGTeamGame/Assets" + File.separator + "Sound" + File.separator+ "Fireball.wav"));
            m.openFromFile(Paths.get("/home/cowleyb/h-drive/SCC210BattleToTheCore-ECSTesting/RPGTeamGame/Assets" + File.separator + "Sound" + File.separator+ "cave_Background.ogg"));
